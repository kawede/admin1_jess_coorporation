        ...
        <div class="col-md-9">
            <div class="card">
              <div class="card-header">
               <label class="col-form-label" for="inputWarning">Choisir mon abonnement</label> 
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="">
                   <main>
                  <!--   <details open> -->
                      <!-- <summary style="color: black; font-family: Arial; font-size: 16px; font-weight: bold;border:2px solid rgb(214,220,229);">Menage</summary> -->
                      <div class="faq__content">
                        <p>
                          <div class="form-group">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox">
                              <label class="form-check-label checked" style="color:black;font-weight:bold;"> Plomberie</label>
                            </div>
                         
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox">
                              <label class="form-check-label" style="color:black;font-weight:bold;">Maintenance</label>
                            </div>
               ...
               <!--      </details> -->
                ...
                <p>
                   <div class="form-group">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox">
                              <label class="form-check-label"style="color:black;font-weight:bold;">1 mois</label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" >
                              <label class="form-check-label"style="color:black;font-weight:bold;">3 mois</label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox">
                              <label class="form-check-label" style="color:black;font-weight:bold;">6 mois</label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox">
                              <label class="form-check-label" style="color:black;font-weight:bold;">12 mois</label>
                            </div>   
                          </div>
                          </p>
                          <hr>
