            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <h5 style="color:black; font-weight:bold;"><i class="fas fa-list-alt" style="color:#18345D; font-size:15px;"></i><span style="color:rgb(255,0,102);">  Consultances & Conseils</span></h5>                
                </div>
              </div>
              <div class="card-body">
                 <div class="row">
