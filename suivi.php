      ...
      <div class="col-md-9">
        <div class="card">
          ...
          <div class="card-body">
                 <div class="row">
                <div class="col-12">
                  <h4 style="color:#18345D; font-weight:bold;">Activités recentes</h4>
                  <hr>
                    <div class="post">
                       <div class="username" style="color:#18345D; font-weight: bold;">12/10/2020 | Plomberie</div>
                      <p style="color:black;">
                       ...
                       <p>
                        <a class="link-black text-sm" style="color:#18345D;"><i class="fas fa-clock mr-1" style="color:#18345D;"></i> 12/12/2022</a> - <a class="link-black text-sm" style="color:#18345D;"><i class="fas fa-clock mr-1" style="color:#18345D;"></i> 12/12/2023 </a>
                        <div class="username" style="color:red;">En cour...</div>
                      </p>
                    </div>
                   ...
                   <div class="post">
                    ...
                    <div class="post">
                       <div class="username" style="color:#18345D; font-weight: bold;">12/10/2020 | Maintenance</div>
                      <p style="color:black;">
                        Lorem ipsum represents a long-held tradition for designers,
                        typographers and the like. Some people hate it and argue for
                        its demise, but others ignore.
                    ...
                    <hr>
                     <a href="abonne.php"><button type="submit" class="btn btn" style="background-color:rgb(255,0,102);  font-weight: bold; color: white;"> Renouvelez son abonnement...</button></a>
                </div>
              </div>
          </div>
          </div>
